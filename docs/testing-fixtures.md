...
| `rdkit_writer_support_counts` | 22 | Count-only RDKit random-writer support evidence. |
...
| `dataset-derived` | 53 | Case came from a molecule dataset and was promoted after review. |
