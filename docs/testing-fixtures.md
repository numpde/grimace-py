...
| `rdkit_writer_support_counts` | 18 | Count-only RDKit random-writer support evidence. |
...
| `dataset-derived` | 49 | Case came from a molecule dataset and was promoted after review. |
