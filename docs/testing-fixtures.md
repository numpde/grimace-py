...
| `rdkit_writer_support_counts` | 27 | Count-only RDKit random-writer support evidence. |
...
| `dataset-derived` | 58 | Case came from a molecule dataset and was promoted after review. |
