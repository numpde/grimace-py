...
| `rdkit_writer_support_counts` | 10 | Count-only RDKit random-writer support evidence. |
...
| `dataset-derived` | 41 | Case came from a molecule dataset and was promoted after review. |
