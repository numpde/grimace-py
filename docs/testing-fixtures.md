...
| `rdkit_writer_support_counts` | 23 | Count-only RDKit random-writer support evidence. |
...
| `dataset-derived` | 54 | Case came from a molecule dataset and was promoted after review. |
