...
| `rdkit_writer_support_counts` | 29 | Count-only RDKit random-writer support evidence. |
...
| `dataset-derived` | 60 | Case came from a molecule dataset and was promoted after review. |
