...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `CC(=O)Oc1ccccc1C(=O)O` | 13 | 304 | **5.5** ± 0.2 ms | **10.7** ± 0.1 ms | **11.2** ± 0.4 ms | **5.8** ± 0.7 ms | **5.6** ± 0.1 ms | **3.9** ± 0.5 ms (230.0 ± 18.8 draws) | **51.1** ± 15.7 ms (3086.7 ± 921.8 draws) |
| `C1CC2(CCO1)CO2` | 8 | 36 | **2.1** ± 0.1 ms | **3.2** ± 0.0 ms | **3.1** ± 0.0 ms | **1.4** ± 0.0 ms | **1.0** ± 0.0 ms | **0.3** ± 0.0 ms (23.0 ± 1.8 draws) | **1.7** ± 0.4 ms (155.6 ± 35.8 draws) |
| `CN1CCC[C@H]1c1cccnc1` | 12 | 136 | **6.6** ± 0.0 ms | **9.7** ± 0.1 ms | **9.4** ± 0.4 ms | **3.8** ± 0.0 ms | **3.5** ± 0.0 ms | **1.7** ± 0.2 ms (97.4 ± 8.7 draws) | **18.2** ± 4.6 ms (987.9 ± 169.9 draws) |
| `CNC(=O)O/N=C(\C)SC` | 10 | 72 | **4.9** ± 0.1 ms | **13.4** ± 0.2 ms | **13.1** ± 0.1 ms | **9.5** ± 0.1 ms | **8.9** ± 0.0 ms | **0.5** ± 0.0 ms (44.1 ± 2.5 draws) | **5.5** ± 1.4 ms (483.0 ± 122.3 draws) |
| `N[C@@H](Cc1ccc(O)c(O)c1)C(=O)O` | 14 | 688 | **9.9** ± 0.1 ms | **25.2** ± 0.2 ms | **22.5** ± 0.1 ms | **14.2** ± 0.1 ms | **12.4** ± 0.0 ms | **9.5** ± 0.2 ms (514.3 ± 12.9 draws) | **142.5** ± 43.6 ms (7946.7 ± 2448.6 draws) |
| `COc1ccc2cc([C@H](C)C(=O)O)ccc2c1` | 17 | 1504 | **17.5** ± 0.1 ms | **56.2** ± 0.8 ms | **48.5** ± 1.1 ms | **34.5** ± 0.2 ms | **30.0** ± 0.2 ms | **25.8** ± 0.8 ms (1143.0 ± 34.0 draws) | **556.5** ± 112.9 ms (24406.3 ± 4916.2 draws) |
