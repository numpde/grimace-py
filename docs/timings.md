...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `CC(=O)Oc1ccccc1C(=O)O` | 13 | 304 | **5.4** ± 0.1 ms | **10.8** ± 0.2 ms | **11.6** ± 0.6 ms | **5.7** ± 0.0 ms | **5.8** ± 0.0 ms | **3.9** ± 0.3 ms (230.0 ± 18.8 draws) | **53.2** ± 15.5 ms (3086.7 ± 921.8 draws) |
| `C1CC2(CCO1)CO2` | 8 | 36 | **2.1** ± 0.0 ms | **3.3** ± 0.0 ms | **3.1** ± 0.1 ms | **1.4** ± 0.0 ms | **1.0** ± 0.0 ms | **0.3** ± 0.0 ms (23.0 ± 1.8 draws) | **1.7** ± 0.4 ms (155.6 ± 35.8 draws) |
| `CN1CCC[C@H]1c1cccnc1` | 12 | 136 | **6.4** ± 0.1 ms | **9.9** ± 0.0 ms | **9.8** ± 0.5 ms | **4.1** ± 0.0 ms | **4.6** ± 0.8 ms | **1.7** ± 0.2 ms (97.4 ± 8.7 draws) | **17.6** ± 3.4 ms (987.9 ± 169.9 draws) |
| `CNC(=O)O/N=C(\C)SC` | 10 | 72 | **5.1** ± 0.2 ms | **14.3** ± 0.4 ms | **14.0** ± 0.5 ms | **10.2** ± 0.2 ms | **9.4** ± 0.0 ms | **0.5** ± 0.0 ms (44.1 ± 2.5 draws) | **5.6** ± 1.4 ms (483.0 ± 122.3 draws) |
| `N[C@@H](Cc1ccc(O)c(O)c1)C(=O)O` | 14 | 688 | **10.1** ± 0.3 ms | **27.9** ± 1.2 ms | **24.8** ± 1.3 ms | **16.0** ± 1.9 ms | **13.6** ± 0.5 ms | **9.6** ± 0.3 ms (514.3 ± 12.9 draws) | **144.1** ± 44.0 ms (7946.7 ± 2448.6 draws) |
| `COc1ccc2cc([C@H](C)C(=O)O)ccc2c1` | 17 | 1504 | **15.6** ± 0.2 ms | **59.1** ± 1.7 ms | **51.9** ± 1.5 ms | **36.0** ± 0.4 ms | **31.8** ± 0.7 ms | **26.2** ± 1.0 ms (1143.0 ± 34.0 draws) | **553.3** ± 111.7 ms (24406.3 ± 4916.2 draws) |
