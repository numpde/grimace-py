...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `CC(=O)Oc1ccccc1C(=O)O` | 13 | 304 | **5.5** ± 0.1 ms | **11.0** ± 0.1 ms | **11.5** ± 0.4 ms | **5.8** ± 0.1 ms | **5.9** ± 0.1 ms | **4.2** ± 0.4 ms (230.0 ± 18.8 draws) | **54.7** ± 16.0 ms (3086.7 ± 921.8 draws) |
| `C1CC2(CCO1)CO2` | 8 | 36 | **2.2** ± 0.0 ms | **3.5** ± 0.1 ms | **3.2** ± 0.1 ms | **1.5** ± 0.0 ms | **1.0** ± 0.0 ms | **0.3** ± 0.0 ms (23.0 ± 1.8 draws) | **1.7** ± 0.4 ms (155.6 ± 35.8 draws) |
| `CN1CCC[C@H]1c1cccnc1` | 12 | 136 | **7.8** ± 0.1 ms | **11.0** ± 0.4 ms | **10.2** ± 0.2 ms | **4.6** ± 0.4 ms | **4.1** ± 0.3 ms | **1.8** ± 0.2 ms (97.4 ± 8.7 draws) | **18.2** ± 2.9 ms (987.9 ± 169.9 draws) |
| `CNC(=O)O/N=C(\C)SC` | 10 | 72 | **5.6** ± 0.2 ms | **17.9** ± 0.1 ms | **17.1** ± 0.1 ms | **13.8** ± 0.1 ms | **12.5** ± 0.1 ms | **0.6** ± 0.0 ms (44.1 ± 2.5 draws) | **5.9** ± 1.5 ms (483.0 ± 122.3 draws) |
| `N[C@@H](Cc1ccc(O)c(O)c1)C(=O)O` | 14 | 688 | **13.4** ± 0.1 ms | **28.3** ± 0.5 ms | **24.7** ± 0.3 ms | **16.2** ± 0.2 ms | **13.9** ± 0.7 ms | **9.7** ± 0.2 ms (514.3 ± 12.9 draws) | **151.8** ± 47.6 ms (7946.7 ± 2448.6 draws) |
| `COc1ccc2cc([C@H](C)C(=O)O)ccc2c1` | 17 | 1504 | **26.9** ± 2.6 ms | **61.6** ± 1.3 ms | **52.9** ± 1.5 ms | **38.8** ± 0.1 ms | **33.6** ± 0.5 ms | **26.3** ± 0.7 ms (1143.0 ± 34.0 draws) | **566.3** ± 113.4 ms (24406.3 ± 4916.2 draws) |
