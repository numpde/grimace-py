...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `CC(=O)Oc1ccccc1C(=O)O` | 13 | 304 | **6.0** ± 0.4 ms | **11.8** ± 0.6 ms | **12.3** ± 0.9 ms | **6.3** ± 0.4 ms | **6.1** ± 0.1 ms | **4.1** ± 0.6 ms (230.0 ± 18.8 draws) | **52.9** ± 15.3 ms (3086.7 ± 921.8 draws) |
| `C1CC2(CCO1)CO2` | 8 | 36 | **2.2** ± 0.0 ms | **3.7** ± 0.6 ms | **3.3** ± 0.2 ms | **1.4** ± 0.0 ms | **1.0** ± 0.0 ms | **0.3** ± 0.0 ms (23.0 ± 1.8 draws) | **1.7** ± 0.4 ms (155.6 ± 35.8 draws) |
| `CN1CCC[C@H]1c1cccnc1` | 12 | 136 | **7.3** ± 0.3 ms | **11.0** ± 0.6 ms | **10.6** ± 1.1 ms | **4.1** ± 0.2 ms | **3.9** ± 0.6 ms | **1.8** ± 0.2 ms (97.4 ± 8.7 draws) | **18.2** ± 3.5 ms (987.9 ± 169.9 draws) |
| `CNC(=O)O/N=C(\C)SC` | 10 | 72 | **5.0** ± 0.1 ms | **13.8** ± 0.2 ms | **14.0** ± 0.9 ms | **10.4** ± 0.8 ms | **9.3** ± 0.0 ms | **0.5** ± 0.0 ms (44.1 ± 2.5 draws) | **5.7** ± 1.4 ms (483.0 ± 122.3 draws) |
| `N[C@@H](Cc1ccc(O)c(O)c1)C(=O)O` | 14 | 688 | **10.4** ± 0.1 ms | **26.3** ± 0.4 ms | **23.1** ± 0.3 ms | **14.8** ± 0.1 ms | **13.6** ± 0.6 ms | **9.8** ± 0.2 ms (514.3 ± 12.9 draws) | **150.4** ± 47.1 ms (7946.7 ± 2448.6 draws) |
| `COc1ccc2cc([C@H](C)C(=O)O)ccc2c1` | 17 | 1504 | **18.6** ± 0.3 ms | **58.4** ± 1.2 ms | **50.8** ± 1.4 ms | **35.9** ± 0.5 ms | **31.3** ± 0.6 ms | **27.0** ± 1.5 ms (1143.0 ± 34.0 draws) | **566.3** ± 113.4 ms (24406.3 ± 4916.2 draws) |
