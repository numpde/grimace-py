...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `CC(=O)Oc1ccccc1C(=O)O` | 13 | 304 | **5.2** ± 0.1 ms | **10.4** ± 0.1 ms | **11.3** ± 0.3 ms | **5.7** ± 0.1 ms | **6.0** ± 0.4 ms | **4.0** ± 0.3 ms (230.0 ± 18.8 draws) | **52.0** ± 15.5 ms (3086.7 ± 921.8 draws) |
| `C1CC2(CCO1)CO2` | 8 | 36 | **2.1** ± 0.0 ms | **3.5** ± 0.5 ms | **3.2** ± 0.4 ms | **1.5** ± 0.3 ms | **1.0** ± 0.0 ms | **0.3** ± 0.0 ms (23.0 ± 1.8 draws) | **1.8** ± 0.4 ms (155.6 ± 35.8 draws) |
| `CN1CCC[C@H]1c1cccnc1` | 12 | 136 | **6.9** ± 0.7 ms | **10.5** ± 0.1 ms | **10.3** ± 0.4 ms | **4.3** ± 0.1 ms | **4.0** ± 0.1 ms | **1.8** ± 0.2 ms (97.4 ± 8.7 draws) | **18.5** ± 3.3 ms (987.9 ± 169.9 draws) |
| `CNC(=O)O/N=C(\C)SC` | 10 | 72 | **5.1** ± 0.2 ms | **14.5** ± 0.4 ms | **14.6** ± 1.1 ms | **10.7** ± 1.1 ms | **9.7** ± 0.3 ms | **0.6** ± 0.0 ms (44.1 ± 2.5 draws) | **5.9** ± 1.5 ms (483.0 ± 122.3 draws) |
| `N[C@@H](Cc1ccc(O)c(O)c1)C(=O)O` | 14 | 688 | **10.0** ± 0.3 ms | **28.0** ± 1.1 ms | **23.5** ± 1.4 ms | **15.5** ± 0.6 ms | **13.1** ± 0.7 ms | **9.8** ± 0.5 ms (514.3 ± 12.9 draws) | **146.0** ± 44.8 ms (7946.7 ± 2448.6 draws) |
| `COc1ccc2cc([C@H](C)C(=O)O)ccc2c1` | 17 | 1504 | **15.7** ± 0.7 ms | **57.0** ± 1.3 ms | **50.5** ± 1.4 ms | **36.6** ± 0.8 ms | **32.3** ± 0.8 ms | **26.6** ± 1.2 ms (1143.0 ± 34.0 draws) | **566.7** ± 118.5 ms (24406.3 ± 4916.2 draws) |
