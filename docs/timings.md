...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `CC(=O)Oc1ccccc1C(=O)O` | 13 | 304 | **5.5** ± 0.2 ms | **18.1** ± 0.6 ms | **16.4** ± 0.5 ms | **4.1** ± 0.4 ms (230.0 ± 18.8 draws) | **53.9** ± 16.3 ms (3086.7 ± 921.8 draws) |
| `C1CC2(CCO1)CO2` | 8 | 36 | **2.2** ± 0.1 ms | **4.9** ± 0.1 ms | **4.0** ± 0.1 ms | **0.3** ± 0.0 ms (23.0 ± 1.8 draws) | **1.8** ± 0.4 ms (155.6 ± 35.8 draws) |
| `CN1CCC[C@H]1c1cccnc1` | 12 | 136 | **9.5** ± 0.3 ms | **37.2** ± 1.3 ms | **36.6** ± 0.9 ms | **1.8** ± 0.2 ms (97.4 ± 8.7 draws) | **17.8** ± 3.2 ms (987.9 ± 169.9 draws) |
| `CNC(=O)O/N=C(\C)SC` | 10 | 72 | **6.7** ± 0.1 ms | **30.2** ± 0.9 ms | **29.0** ± 0.8 ms | **0.6** ± 0.0 ms (44.1 ± 2.5 draws) | **5.8** ± 1.4 ms (483.0 ± 122.3 draws) |
| `N[C@@H](Cc1ccc(O)c(O)c1)C(=O)O` | 14 | 688 | **20.6** ± 0.7 ms | **145.9** ± 1.0 ms | **143.8** ± 3.2 ms | **10.0** ± 0.5 ms (514.3 ± 12.9 draws) | **151.3** ± 46.5 ms (7946.7 ± 2448.6 draws) |
| `COc1ccc2cc([C@H](C)C(=O)O)ccc2c1` | 17 | 1504 | **44.7** ± 0.7 ms | **383.4** ± 4.5 ms | **376.1** ± 4.7 ms | **26.9** ± 0.9 ms (1143.0 ± 34.0 draws) | **576.9** ± 112.5 ms (24406.3 ± 4916.2 draws) |
