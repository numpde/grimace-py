...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `CC(=O)Oc1ccccc1C(=O)O` | 13 | 304 | **5.6** ± 0.3 ms | **11.1** ± 0.3 ms | **11.4** ± 0.4 ms | **5.8** ± 0.0 ms | **6.0** ± 0.1 ms | **4.3** ± 0.5 ms (230.0 ± 18.8 draws) | **53.6** ± 16.0 ms (3086.7 ± 921.8 draws) |
| `C1CC2(CCO1)CO2` | 8 | 36 | **2.2** ± 0.0 ms | **3.4** ± 0.1 ms | **3.1** ± 0.0 ms | **1.5** ± 0.0 ms | **1.0** ± 0.0 ms | **0.3** ± 0.0 ms (23.0 ± 1.8 draws) | **1.8** ± 0.4 ms (155.6 ± 35.8 draws) |
| `CN1CCC[C@H]1c1cccnc1` | 12 | 136 | **7.4** ± 0.1 ms | **11.0** ± 0.0 ms | **10.6** ± 0.1 ms | **4.6** ± 0.1 ms | **4.1** ± 0.0 ms | **1.8** ± 0.2 ms (97.4 ± 8.7 draws) | **17.8** ± 3.1 ms (987.9 ± 169.9 draws) |
| `CNC(=O)O/N=C(\C)SC` | 10 | 72 | **5.4** ± 0.1 ms | **17.7** ± 0.3 ms | **16.7** ± 0.1 ms | **13.6** ± 0.1 ms | **12.5** ± 0.5 ms | **0.5** ± 0.0 ms (44.1 ± 2.5 draws) | **5.7** ± 1.3 ms (483.0 ± 122.3 draws) |
| `N[C@@H](Cc1ccc(O)c(O)c1)C(=O)O` | 14 | 688 | **12.8** ± 0.5 ms | **29.2** ± 0.2 ms | **26.0** ± 0.4 ms | **17.1** ± 0.1 ms | **14.5** ± 0.1 ms | **10.9** ± 0.5 ms (514.3 ± 12.9 draws) | **158.4** ± 48.1 ms (7946.7 ± 2448.6 draws) |
| `COc1ccc2cc([C@H](C)C(=O)O)ccc2c1` | 17 | 1504 | **22.7** ± 0.3 ms | **61.3** ± 1.0 ms | **54.9** ± 2.3 ms | **41.2** ± 1.3 ms | **35.5** ± 0.9 ms | **28.1** ± 1.2 ms (1143.0 ± 34.0 draws) | **567.1** ± 113.6 ms (24406.3 ± 4916.2 draws) |
