...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `CC(=O)Oc1ccccc1C(=O)O` | 13 | 304 | **6.2** ± 1.0 ms | **11.1** ± 0.2 ms | **11.4** ± 0.5 ms | **6.0** ± 0.3 ms | **5.8** ± 0.0 ms | **4.1** ± 0.3 ms (230.0 ± 18.8 draws) | **54.8** ± 17.2 ms (3086.7 ± 921.8 draws) |
| `C1CC2(CCO1)CO2` | 8 | 36 | **2.4** ± 0.1 ms | **3.5** ± 0.1 ms | **3.2** ± 0.0 ms | **1.5** ± 0.0 ms | **1.0** ± 0.0 ms | **0.3** ± 0.0 ms (23.0 ± 1.8 draws) | **1.8** ± 0.4 ms (155.6 ± 35.8 draws) |
| `CN1CCC[C@H]1c1cccnc1` | 12 | 136 | **8.2** ± 1.1 ms | **11.4** ± 0.4 ms | **11.1** ± 1.3 ms | **4.8** ± 0.6 ms | **4.0** ± 0.1 ms | **1.8** ± 0.2 ms (97.4 ± 8.7 draws) | **17.7** ± 3.2 ms (987.9 ± 169.9 draws) |
| `CNC(=O)O/N=C(\C)SC` | 10 | 72 | **5.8** ± 0.9 ms | **19.7** ± 1.9 ms | **17.3** ± 0.6 ms | **14.3** ± 0.6 ms | **12.5** ± 0.4 ms | **0.5** ± 0.0 ms (44.1 ± 2.5 draws) | **5.7** ± 1.5 ms (483.0 ± 122.3 draws) |
| `N[C@@H](Cc1ccc(O)c(O)c1)C(=O)O` | 14 | 688 | **14.3** ± 0.6 ms | **29.4** ± 2.5 ms | **26.6** ± 2.0 ms | **16.9** ± 1.1 ms | **14.0** ± 0.2 ms | **9.7** ± 0.2 ms (514.3 ± 12.9 draws) | **151.7** ± 46.4 ms (7946.7 ± 2448.6 draws) |
| `COc1ccc2cc([C@H](C)C(=O)O)ccc2c1` | 17 | 1504 | **29.6** ± 1.4 ms | **75.6** ± 11.1 ms | **60.1** ± 1.9 ms | **40.3** ± 1.2 ms | **34.8** ± 1.0 ms | **26.4** ± 1.0 ms (1143.0 ± 34.0 draws) | **571.1** ± 113.0 ms (24406.3 ± 4916.2 draws) |
