...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `CC(=O)Oc1ccccc1C(=O)O` | 13 | 304 | **5.7** ± 0.1 ms | **18.2** ± 0.7 ms | **16.4** ± 0.2 ms | **4.0** ± 0.3 ms (230.0 ± 18.8 draws) | **54.5** ± 15.6 ms (3086.7 ± 921.8 draws) |
| `C1CC2(CCO1)CO2` | 8 | 36 | **2.2** ± 0.0 ms | **5.3** ± 0.3 ms | **4.2** ± 0.3 ms | **0.3** ± 0.0 ms (23.0 ± 1.8 draws) | **1.8** ± 0.4 ms (155.6 ± 35.8 draws) |
| `CN1CCC[C@H]1c1cccnc1` | 12 | 136 | **9.2** ± 0.1 ms | **39.2** ± 3.0 ms | **37.8** ± 2.1 ms | **1.7** ± 0.2 ms (97.4 ± 8.7 draws) | **18.4** ± 3.5 ms (987.9 ± 169.9 draws) |
| `CNC(=O)O/N=C(\C)SC` | 10 | 72 | **7.1** ± 1.0 ms | **31.4** ± 1.8 ms | **31.0** ± 1.6 ms | **0.6** ± 0.0 ms (44.1 ± 2.5 draws) | **5.9** ± 1.5 ms (483.0 ± 122.3 draws) |
| `N[C@@H](Cc1ccc(O)c(O)c1)C(=O)O` | 14 | 688 | **22.8** ± 1.4 ms | **151.9** ± 2.8 ms | **146.3** ± 2.6 ms | **10.4** ± 1.0 ms (514.3 ± 12.9 draws) | **152.6** ± 46.9 ms (7946.7 ± 2448.6 draws) |
| `COc1ccc2cc([C@H](C)C(=O)O)ccc2c1` | 17 | 1504 | **45.1** ± 2.4 ms | **398.1** ± 5.6 ms | **392.3** ± 5.2 ms | **27.1** ± 0.8 ms (1143.0 ± 34.0 draws) | **589.5** ± 115.0 ms (24406.3 ± 4916.2 draws) |
