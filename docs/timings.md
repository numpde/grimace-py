...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `CC(=O)Oc1ccccc1C(=O)O` | 13 | 304 | **5.7** ± 0.5 ms | **10.6** ± 0.1 ms | **11.5** ± 0.7 ms | **5.8** ± 0.1 ms | **5.8** ± 0.1 ms | **4.0** ± 0.3 ms (230.0 ± 18.8 draws) | **53.4** ± 16.1 ms (3086.7 ± 921.8 draws) |
| `C1CC2(CCO1)CO2` | 8 | 36 | **2.2** ± 0.0 ms | **3.4** ± 0.1 ms | **3.1** ± 0.1 ms | **1.4** ± 0.0 ms | **1.0** ± 0.0 ms | **0.3** ± 0.0 ms (23.0 ± 1.8 draws) | **1.7** ± 0.4 ms (155.6 ± 35.8 draws) |
| `CN1CCC[C@H]1c1cccnc1` | 12 | 136 | **6.9** ± 0.1 ms | **10.3** ± 0.1 ms | **9.9** ± 0.2 ms | **4.4** ± 0.1 ms | **3.8** ± 0.1 ms | **1.8** ± 0.2 ms (97.4 ± 8.7 draws) | **17.9** ± 3.2 ms (987.9 ± 169.9 draws) |
| `CNC(=O)O/N=C(\C)SC` | 10 | 72 | **5.3** ± 0.1 ms | **17.5** ± 0.2 ms | **16.4** ± 0.2 ms | **13.4** ± 0.4 ms | **12.1** ± 0.1 ms | **0.5** ± 0.0 ms (44.1 ± 2.5 draws) | **5.7** ± 1.4 ms (483.0 ± 122.3 draws) |
| `N[C@@H](Cc1ccc(O)c(O)c1)C(=O)O` | 14 | 688 | **12.0** ± 1.1 ms | **27.7** ± 0.2 ms | **23.7** ± 0.3 ms | **15.6** ± 0.1 ms | **13.3** ± 0.1 ms | **9.7** ± 0.3 ms (514.3 ± 12.9 draws) | **149.7** ± 46.7 ms (7946.7 ± 2448.6 draws) |
| `COc1ccc2cc([C@H](C)C(=O)O)ccc2c1` | 17 | 1504 | **20.9** ± 0.5 ms | **59.6** ± 1.1 ms | **52.5** ± 1.3 ms | **37.5** ± 0.1 ms | **32.3** ± 0.2 ms | **26.1** ± 0.7 ms (1143.0 ± 34.0 draws) | **560.3** ± 112.6 ms (24406.3 ± 4916.2 draws) |
