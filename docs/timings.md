...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `CC(=O)Oc1ccccc1C(=O)O` | 13 | 304 | **5.5** ± 0.1 ms | **11.5** ± 1.1 ms | **12.6** ± 1.3 ms | **4.2** ± 0.4 ms (230.0 ± 18.8 draws) | **55.9** ± 16.8 ms (3086.7 ± 921.8 draws) |
| `C1CC2(CCO1)CO2` | 8 | 36 | **2.1** ± 0.0 ms | **3.5** ± 0.1 ms | **3.2** ± 0.3 ms | **0.3** ± 0.0 ms (23.0 ± 1.8 draws) | **1.8** ± 0.4 ms (155.6 ± 35.8 draws) |
| `CN1CCC[C@H]1c1cccnc1` | 12 | 136 | **8.3** ± 0.2 ms | **10.9** ± 0.7 ms | **10.8** ± 0.5 ms | **1.8** ± 0.2 ms (97.4 ± 8.7 draws) | **18.5** ± 3.1 ms (987.9 ± 169.9 draws) |
| `CNC(=O)O/N=C(\C)SC` | 10 | 72 | **5.8** ± 0.1 ms | **18.8** ± 1.4 ms | **18.2** ± 0.9 ms | **0.6** ± 0.0 ms (44.1 ± 2.5 draws) | **6.0** ± 1.6 ms (483.0 ± 122.3 draws) |
| `N[C@@H](Cc1ccc(O)c(O)c1)C(=O)O` | 14 | 688 | **15.0** ± 0.4 ms | **29.7** ± 1.6 ms | **26.2** ± 1.8 ms | **9.9** ± 0.4 ms (514.3 ± 12.9 draws) | **149.6** ± 46.9 ms (7946.7 ± 2448.6 draws) |
| `COc1ccc2cc([C@H](C)C(=O)O)ccc2c1` | 17 | 1504 | **28.6** ± 0.6 ms | **62.5** ± 4.0 ms | **60.3** ± 2.7 ms | **26.1** ± 0.8 ms (1143.0 ± 34.0 draws) | **564.4** ± 113.9 ms (24406.3 ± 4916.2 draws) |
