...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `CC(=O)Oc1ccccc1C(=O)O` | 13 | 304 | **5.3** ± 0.0 ms | **17.3** ± 0.4 ms | **16.9** ± 0.4 ms | **4.2** ± 0.4 ms (230.0 ± 18.8 draws) | **55.0** ± 16.2 ms (3086.7 ± 921.8 draws) |
| `C1CC2(CCO1)CO2` | 8 | 36 | **2.3** ± 0.3 ms | **5.0** ± 0.1 ms | **4.3** ± 0.3 ms | **0.3** ± 0.0 ms (23.0 ± 1.8 draws) | **1.8** ± 0.4 ms (155.6 ± 35.8 draws) |
| `CN1CCC[C@H]1c1cccnc1` | 12 | 136 | **10.4** ± 0.1 ms | **47.0** ± 2.3 ms | **45.0** ± 0.1 ms | **1.8** ± 0.2 ms (97.4 ± 8.7 draws) | **17.9** ± 3.1 ms (987.9 ± 169.9 draws) |
| `CNC(=O)O/N=C(\C)SC` | 10 | 72 | **7.5** ± 0.1 ms | **37.4** ± 0.5 ms | **36.7** ± 0.4 ms | **0.5** ± 0.0 ms (44.1 ± 2.5 draws) | **5.7** ± 1.4 ms (483.0 ± 122.3 draws) |
| `N[C@@H](Cc1ccc(O)c(O)c1)C(=O)O` | 14 | 688 | **23.4** ± 0.1 ms | **185.0** ± 1.8 ms | **182.6** ± 1.2 ms | **9.7** ± 0.3 ms (514.3 ± 12.9 draws) | **150.5** ± 47.3 ms (7946.7 ± 2448.6 draws) |
| `COc1ccc2cc([C@H](C)C(=O)O)ccc2c1` | 17 | 1504 | **52.1** ± 0.8 ms | **502.7** ± 2.6 ms | **498.8** ± 3.0 ms | **26.2** ± 0.8 ms (1143.0 ± 34.0 draws) | **559.3** ± 112.5 ms (24406.3 ± 4916.2 draws) |
