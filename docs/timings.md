...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `CC(=O)Oc1ccccc1C(=O)O` | 13 | 304 | **6.1** ± 0.2 ms | **11.5** ± 0.2 ms | **12.5** ± 1.3 ms | **6.3** ± 0.7 ms | **6.0** ± 0.1 ms | **4.0** ± 0.3 ms (230.0 ± 18.8 draws) | **53.4** ± 15.6 ms (3086.7 ± 921.8 draws) |
| `C1CC2(CCO1)CO2` | 8 | 36 | **2.4** ± 0.2 ms | **3.7** ± 0.2 ms | **3.2** ± 0.1 ms | **1.5** ± 0.1 ms | **1.0** ± 0.0 ms | **0.3** ± 0.0 ms (23.0 ± 1.8 draws) | **1.8** ± 0.4 ms (155.6 ± 35.8 draws) |
| `CN1CCC[C@H]1c1cccnc1` | 12 | 136 | **7.3** ± 0.1 ms | **10.2** ± 0.1 ms | **10.7** ± 1.2 ms | **3.9** ± 0.1 ms | **3.8** ± 0.3 ms | **1.8** ± 0.2 ms (97.4 ± 8.7 draws) | **17.4** ± 3.2 ms (987.9 ± 169.9 draws) |
| `CNC(=O)O/N=C(\C)SC` | 10 | 72 | **5.0** ± 0.1 ms | **15.5** ± 0.1 ms | **15.4** ± 0.1 ms | **12.3** ± 0.6 ms | **11.7** ± 1.0 ms | **0.5** ± 0.0 ms (44.1 ± 2.5 draws) | **5.6** ± 1.4 ms (483.0 ± 122.3 draws) |
| `N[C@@H](Cc1ccc(O)c(O)c1)C(=O)O` | 14 | 688 | **10.8** ± 0.2 ms | **27.0** ± 2.1 ms | **23.2** ± 0.9 ms | **14.2** ± 0.2 ms | **12.8** ± 0.0 ms | **9.7** ± 0.2 ms (514.3 ± 12.9 draws) | **149.0** ± 45.7 ms (7946.7 ± 2448.6 draws) |
| `COc1ccc2cc([C@H](C)C(=O)O)ccc2c1` | 17 | 1504 | **19.2** ± 0.5 ms | **55.8** ± 1.6 ms | **51.8** ± 3.1 ms | **35.7** ± 1.4 ms | **31.5** ± 1.4 ms | **26.5** ± 1.2 ms (1143.0 ± 34.0 draws) | **569.6** ± 112.8 ms (24406.3 ± 4916.2 draws) |
