...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `CC(=O)Oc1ccccc1C(=O)O` | 13 | 304 | **5.5** ± 0.1 ms | **11.8** ± 1.4 ms | **12.4** ± 1.2 ms | **5.9** ± 0.1 ms | **6.0** ± 0.0 ms | **4.3** ± 0.8 ms (230.0 ± 18.8 draws) | **53.3** ± 15.7 ms (3086.7 ± 921.8 draws) |
| `C1CC2(CCO1)CO2` | 8 | 36 | **2.6** ± 0.7 ms | **3.4** ± 0.1 ms | **3.3** ± 0.2 ms | **1.5** ± 0.0 ms | **1.0** ± 0.0 ms | **0.4** ± 0.2 ms (23.0 ± 1.8 draws) | **2.0** ± 0.6 ms (155.6 ± 35.8 draws) |
| `CN1CCC[C@H]1c1cccnc1` | 12 | 136 | **7.0** ± 0.3 ms | **10.6** ± 0.2 ms | **9.8** ± 0.1 ms | **4.1** ± 0.1 ms | **3.7** ± 0.0 ms | **1.7** ± 0.2 ms (97.4 ± 8.7 draws) | **18.0** ± 3.5 ms (987.9 ± 169.9 draws) |
| `CNC(=O)O/N=C(\C)SC` | 10 | 72 | **5.1** ± 0.7 ms | **15.7** ± 1.4 ms | **14.9** ± 2.2 ms | **10.7** ± 1.1 ms | **10.0** ± 0.9 ms | **0.6** ± 0.1 ms (44.1 ± 2.5 draws) | **5.8** ± 1.5 ms (483.0 ± 122.3 draws) |
| `N[C@@H](Cc1ccc(O)c(O)c1)C(=O)O` | 14 | 688 | **10.1** ± 0.1 ms | **29.0** ± 3.6 ms | **25.1** ± 3.1 ms | **15.4** ± 0.8 ms | **13.7** ± 0.5 ms | **9.9** ± 0.4 ms (514.3 ± 12.9 draws) | **151.9** ± 46.9 ms (7946.7 ± 2448.6 draws) |
| `COc1ccc2cc([C@H](C)C(=O)O)ccc2c1` | 17 | 1504 | **17.4** ± 0.3 ms | **64.0** ± 3.2 ms | **57.7** ± 7.9 ms | **37.9** ± 2.0 ms | **32.7** ± 1.4 ms | **28.4** ± 2.4 ms (1143.0 ± 34.0 draws) | **575.3** ± 117.9 ms (24406.3 ± 4916.2 draws) |
