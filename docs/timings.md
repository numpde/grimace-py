...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `CC(=O)Oc1ccccc1C(=O)O` | 13 | 304 | **5.4** ± 0.1 ms | **17.6** ± 1.7 ms | **15.8** ± 0.1 ms | **3.8** ± 0.3 ms (230.0 ± 18.8 draws) | **51.1** ± 15.2 ms (3086.7 ± 921.8 draws) |
| `C1CC2(CCO1)CO2` | 8 | 36 | **2.2** ± 0.0 ms | **4.6** ± 0.0 ms | **3.9** ± 0.1 ms | **0.3** ± 0.0 ms (23.0 ± 1.8 draws) | **1.7** ± 0.4 ms (155.6 ± 35.8 draws) |
| `CN1CCC[C@H]1c1cccnc1` | 12 | 136 | **8.2** ± 0.1 ms | **31.1** ± 0.8 ms | **30.2** ± 0.6 ms | **1.7** ± 0.2 ms (97.4 ± 8.7 draws) | **16.8** ± 2.9 ms (987.9 ± 169.9 draws) |
| `CNC(=O)O/N=C(\C)SC` | 10 | 72 | **5.4** ± 0.1 ms | **21.7** ± 0.5 ms | **21.4** ± 0.5 ms | **0.5** ± 0.0 ms (44.1 ± 2.5 draws) | **5.6** ± 1.4 ms (483.0 ± 122.3 draws) |
| `N[C@@H](Cc1ccc(O)c(O)c1)C(=O)O` | 14 | 688 | **16.5** ± 0.4 ms | **105.7** ± 0.5 ms | **104.0** ± 0.6 ms | **9.5** ± 0.2 ms (514.3 ± 12.9 draws) | **145.1** ± 43.9 ms (7946.7 ± 2448.6 draws) |
| `COc1ccc2cc([C@H](C)C(=O)O)ccc2c1` | 17 | 1504 | **33.9** ± 0.3 ms | **295.3** ± 4.7 ms | **292.3** ± 3.4 ms | **25.8** ± 0.8 ms (1143.0 ± 34.0 draws) | **566.9** ± 120.4 ms (24406.3 ± 4916.2 draws) |
