...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `CC(=O)Oc1ccccc1C(=O)O` | 13 | 304 | **5.8** ± 1.1 ms | **18.2** ± 1.3 ms | **17.8** ± 0.7 ms | **4.5** ± 0.3 ms (230.0 ± 18.8 draws) | **58.3** ± 17.5 ms (3086.7 ± 921.8 draws) |
| `C1CC2(CCO1)CO2` | 8 | 36 | **2.7** ± 0.9 ms | **5.1** ± 0.1 ms | **4.2** ± 0.0 ms | **0.3** ± 0.0 ms (23.0 ± 1.8 draws) | **2.2** ± 1.3 ms (155.6 ± 35.8 draws) |
| `CN1CCC[C@H]1c1cccnc1` | 12 | 136 | **11.5** ± 0.5 ms | **52.2** ± 2.0 ms | **51.5** ± 2.3 ms | **1.9** ± 0.2 ms (97.4 ± 8.7 draws) | **19.1** ± 3.3 ms (987.9 ± 169.9 draws) |
| `CNC(=O)O/N=C(\C)SC` | 10 | 72 | **8.0** ± 0.3 ms | **41.5** ± 0.7 ms | **42.0** ± 1.1 ms | **0.6** ± 0.0 ms (44.1 ± 2.5 draws) | **6.3** ± 1.6 ms (483.0 ± 122.3 draws) |
| `N[C@@H](Cc1ccc(O)c(O)c1)C(=O)O` | 14 | 688 | **27.5** ± 1.1 ms | **219.4** ± 1.8 ms | **218.1** ± 1.8 ms | **9.9** ± 0.2 ms (514.3 ± 12.9 draws) | **153.5** ± 48.0 ms (7946.7 ± 2448.6 draws) |
| `COc1ccc2cc([C@H](C)C(=O)O)ccc2c1` | 17 | 1504 | **57.2** ± 0.7 ms | **581.8** ± 3.4 ms | **574.7** ± 4.7 ms | **27.4** ± 0.7 ms (1143.0 ± 34.0 draws) | **584.5** ± 115.7 ms (24406.3 ± 4916.2 draws) |
