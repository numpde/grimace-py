...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `CC(=O)Oc1ccccc1C(=O)O` | 13 | 304 | **6.2** ± 1.0 ms | **11.0** ± 0.2 ms | **11.4** ± 0.4 ms | **5.9** ± 0.1 ms | **5.8** ± 0.0 ms | **4.0** ± 0.3 ms (230.0 ± 18.8 draws) | **52.8** ± 16.3 ms (3086.7 ± 921.8 draws) |
| `C1CC2(CCO1)CO2` | 8 | 36 | **2.1** ± 0.1 ms | **3.7** ± 0.7 ms | **3.1** ± 0.1 ms | **1.4** ± 0.0 ms | **1.0** ± 0.0 ms | **0.3** ± 0.0 ms (23.0 ± 1.8 draws) | **1.7** ± 0.4 ms (155.6 ± 35.8 draws) |
| `CN1CCC[C@H]1c1cccnc1` | 12 | 136 | **6.7** ± 0.2 ms | **10.2** ± 0.1 ms | **10.3** ± 0.3 ms | **4.2** ± 0.1 ms | **4.0** ± 0.6 ms | **1.8** ± 0.2 ms (97.4 ± 8.7 draws) | **17.7** ± 3.0 ms (987.9 ± 169.9 draws) |
| `CNC(=O)O/N=C(\C)SC` | 10 | 72 | **4.8** ± 0.1 ms | **13.5** ± 0.1 ms | **13.2** ± 0.2 ms | **9.9** ± 0.1 ms | **9.6** ± 0.7 ms | **0.5** ± 0.0 ms (44.1 ± 2.5 draws) | **5.7** ± 1.4 ms (483.0 ± 122.3 draws) |
| `N[C@@H](Cc1ccc(O)c(O)c1)C(=O)O` | 14 | 688 | **9.6** ± 0.1 ms | **27.6** ± 0.9 ms | **23.7** ± 1.6 ms | **15.0** ± 0.8 ms | **12.8** ± 0.1 ms | **9.6** ± 0.2 ms (514.3 ± 12.9 draws) | **148.6** ± 44.8 ms (7946.7 ± 2448.6 draws) |
| `COc1ccc2cc([C@H](C)C(=O)O)ccc2c1` | 17 | 1504 | **15.4** ± 0.1 ms | **58.3** ± 1.7 ms | **50.2** ± 1.1 ms | **35.2** ± 0.3 ms | **31.2** ± 0.2 ms | **26.2** ± 0.6 ms (1143.0 ± 34.0 draws) | **560.0** ± 111.9 ms (24406.3 ± 4916.2 draws) |
