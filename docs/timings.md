...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `CC(=O)Oc1ccccc1C(=O)O` | 13 | 304 | **5.6** ± 0.1 ms | **10.7** ± 0.2 ms | **11.5** ± 0.4 ms | **4.1** ± 0.3 ms (230.0 ± 18.8 draws) | **55.4** ± 16.7 ms (3086.7 ± 921.8 draws) |
| `C1CC2(CCO1)CO2` | 8 | 36 | **2.3** ± 0.0 ms | **3.5** ± 0.1 ms | **3.2** ± 0.0 ms | **0.3** ± 0.0 ms (23.0 ± 1.8 draws) | **1.8** ± 0.4 ms (155.6 ± 35.8 draws) |
| `CN1CCC[C@H]1c1cccnc1` | 12 | 136 | **8.4** ± 0.1 ms | **10.8** ± 0.1 ms | **10.4** ± 0.1 ms | **1.8** ± 0.2 ms (97.4 ± 8.7 draws) | **18.1** ± 3.1 ms (987.9 ± 169.9 draws) |
| `CNC(=O)O/N=C(\C)SC` | 10 | 72 | **5.7** ± 0.2 ms | **17.6** ± 0.2 ms | **17.8** ± 0.1 ms | **0.5** ± 0.0 ms (44.1 ± 2.5 draws) | **5.9** ± 1.5 ms (483.0 ± 122.3 draws) |
| `N[C@@H](Cc1ccc(O)c(O)c1)C(=O)O` | 14 | 688 | **14.9** ± 0.1 ms | **25.5** ± 0.3 ms | **23.3** ± 0.1 ms | **9.6** ± 0.3 ms (514.3 ± 12.9 draws) | **145.2** ± 44.0 ms (7946.7 ± 2448.6 draws) |
| `COc1ccc2cc([C@H](C)C(=O)O)ccc2c1` | 17 | 1504 | **27.7** ± 0.7 ms | **54.7** ± 1.2 ms | **50.8** ± 0.9 ms | **26.0** ± 0.8 ms (1143.0 ± 34.0 draws) | **550.3** ± 109.4 ms (24406.3 ± 4916.2 draws) |
