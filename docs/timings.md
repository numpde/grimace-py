...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `CC(=O)Oc1ccccc1C(=O)O` | 13 | 304 | **5.5** ± 0.4 ms | **11.0** ± 0.1 ms | **11.6** ± 0.5 ms | **6.2** ± 0.9 ms | **6.2** ± 0.6 ms | **4.2** ± 0.5 ms (230.0 ± 18.8 draws) | **53.4** ± 16.1 ms (3086.7 ± 921.8 draws) |
| `C1CC2(CCO1)CO2` | 8 | 36 | **2.2** ± 0.0 ms | **3.4** ± 0.2 ms | **3.6** ± 1.0 ms | **1.5** ± 0.0 ms | **1.1** ± 0.0 ms | **0.3** ± 0.0 ms (23.0 ± 1.8 draws) | **1.8** ± 0.4 ms (155.6 ± 35.8 draws) |
| `CN1CCC[C@H]1c1cccnc1` | 12 | 136 | **7.0** ± 0.4 ms | **10.3** ± 0.2 ms | **10.3** ± 0.3 ms | **4.1** ± 0.1 ms | **3.7** ± 0.1 ms | **1.8** ± 0.2 ms (97.4 ± 8.7 draws) | **17.5** ± 3.0 ms (987.9 ± 169.9 draws) |
| `CNC(=O)O/N=C(\C)SC` | 10 | 72 | **4.9** ± 0.1 ms | **13.9** ± 0.7 ms | **13.4** ± 0.1 ms | **9.8** ± 0.0 ms | **9.1** ± 0.1 ms | **0.5** ± 0.0 ms (44.1 ± 2.5 draws) | **5.7** ± 1.4 ms (483.0 ± 122.3 draws) |
| `N[C@@H](Cc1ccc(O)c(O)c1)C(=O)O` | 14 | 688 | **9.7** ± 0.1 ms | **26.1** ± 0.7 ms | **22.7** ± 0.1 ms | **14.7** ± 0.3 ms | **12.9** ± 0.1 ms | **9.9** ± 0.6 ms (514.3 ± 12.9 draws) | **151.5** ± 46.3 ms (7946.7 ± 2448.6 draws) |
| `COc1ccc2cc([C@H](C)C(=O)O)ccc2c1` | 17 | 1504 | **17.0** ± 1.4 ms | **58.5** ± 1.7 ms | **51.1** ± 1.6 ms | **35.4** ± 0.3 ms | **30.5** ± 0.1 ms | **26.3** ± 0.7 ms (1143.0 ± 34.0 draws) | **569.1** ± 122.8 ms (24406.3 ± 4916.2 draws) |
