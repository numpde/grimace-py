...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `CC(=O)Oc1ccccc1C(=O)O` | 13 | 304 | **7.0** ± 0.3 ms | **21.2** ± 1.0 ms | **19.8** ± 0.3 ms | **4.5** ± 0.4 ms (230.0 ± 18.8 draws) | **60.8** ± 18.1 ms (3086.7 ± 921.8 draws) |
| `C1CC2(CCO1)CO2` | 8 | 36 | **2.7** ± 0.4 ms | **5.6** ± 0.3 ms | **4.7** ± 0.4 ms | **0.3** ± 0.1 ms (23.0 ± 1.8 draws) | **2.2** ± 0.5 ms (155.6 ± 35.8 draws) |
| `CN1CCC[C@H]1c1cccnc1` | 12 | 136 | **13.7** ± 1.0 ms | **67.9** ± 3.0 ms | **69.4** ± 2.4 ms | **1.9** ± 0.2 ms (97.4 ± 8.7 draws) | **19.9** ± 3.5 ms (987.9 ± 169.9 draws) |
| `CNC(=O)O/N=C(\C)SC` | 10 | 72 | **8.6** ± 0.9 ms | **52.1** ± 1.2 ms | **52.9** ± 1.2 ms | **0.7** ± 0.1 ms (44.1 ± 2.5 draws) | **6.6** ± 1.9 ms (483.0 ± 122.3 draws) |
| `N[C@@H](Cc1ccc(O)c(O)c1)C(=O)O` | 14 | 688 | **35.6** ± 1.5 ms | **290.2** ± 4.7 ms | **292.0** ± 4.3 ms | **9.9** ± 0.2 ms (514.3 ± 12.9 draws) | **151.1** ± 44.6 ms (7946.7 ± 2448.6 draws) |
| `COc1ccc2cc([C@H](C)C(=O)O)ccc2c1` | 17 | 1504 | **69.4** ± 2.5 ms | **812.9** ± 27.5 ms | **797.2** ± 10.8 ms | **27.9** ± 0.8 ms (1143.0 ± 34.0 draws) | **608.0** ± 133.2 ms (24406.3 ± 4916.2 draws) |
