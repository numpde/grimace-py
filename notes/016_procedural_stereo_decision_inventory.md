...
The next task should classify each surface above. The important distinction is
not "row or no row"; it is whether the decision belongs to principled
stereo/graph semantics, RDKit writer policy, a temporary adapter/assertion, or
an obsolete repair.
