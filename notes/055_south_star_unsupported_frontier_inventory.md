...
| `aromatic_ring_surface` | `c1ccccc1C` or `c1cc[nH]c1` | Aromatic coverage beyond markerless unmodified monocycles. | Next aromatic subfamily split. |
...
2. fused aromatic systems without directional overlays;
3. modified aromatic atom text such as `[nH]`;
