...
- total benchmark/readiness rows: `63`.
...
`South Star 193` pins `[si]1ccccc1` as a normalization fixture for the
supported non-aromatic silicon Kekule ring surface, not as aromatic silicon
support.
