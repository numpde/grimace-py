...
class WriterGraphObligationWorkEvidence:
    ...
    deferred_control_live_closure_candidate_count: int
...
class WriterGraphObligationWorkEnvelope:
    ...
    max_deferred_control_live_closure_candidate_count: int | None = None
...
_PUBLIC_GRAPH_OBLIGATION_MAX_COMPONENT_ATOM_COUNT = 12
_PUBLIC_GRAPH_OBLIGATION_MAX_COMPONENT_BOND_COUNT = 13
_PUBLIC_GRAPH_OBLIGATION_MAX_EDGE_OBLIGATION_COUNT = 13
_PUBLIC_GRAPH_OBLIGATION_MAX_RESIDUAL_ATTACHMENT_COUNT = 5
_PUBLIC_GRAPH_OBLIGATION_MAX_RESIDUAL_ATTACHMENT_ACTION_COUNT = 5
_PUBLIC_GRAPH_OBLIGATION_MAX_BOUNDARY_INCIDENCE_COUNT = 5
_PUBLIC_GRAPH_OBLIGATION_MAX_CLOSURE_CANDIDATE_COUNT = 2
_PUBLIC_GRAPH_OBLIGATION_MAX_LIVE_BRANCH_RETURN_CLOSURE_CANDIDATE_COUNT = 2
_PUBLIC_GRAPH_OBLIGATION_MAX_DEFERRED_BRANCH_RETURN_CLOSURE_CANDIDATE_COUNT = 1
_PUBLIC_GRAPH_OBLIGATION_MAX_DEFERRED_CONTROL_LIVE_CLOSURE_CANDIDATE_COUNT = 1
...
_PUBLIC_GRAPH_OBLIGATION_MAX_ATTACHMENT_ATOM_COUNT = 12
...
_PUBLIC_WRITER_GRAPH_OBLIGATION_WORK_ENVELOPE = (
    WriterGraphObligationWorkEnvelope(
        ...
        max_deferred_control_live_closure_candidate_count=(
            _PUBLIC_GRAPH_OBLIGATION_MAX_DEFERRED_CONTROL_LIVE_CLOSURE_CANDIDATE_COUNT
        ),
