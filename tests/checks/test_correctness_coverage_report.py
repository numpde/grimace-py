        ...
        self.assertEqual(
            {
                ...
                PINNED_RDKIT_WRITER_MEMBERSHIP: {RDKIT_VERSION: 55},
                PINNED_RDKIT_DETERMINISTIC_UNOBSERVED: {RDKIT_VERSION: 1},
                PINNED_RDKIT_WRITER_SUPPORT_COUNTS: {RDKIT_VERSION: 30},
