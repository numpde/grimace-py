...
class ReferenceRootedExportsTests(unittest.TestCase):
    def test_connected_nonstereo_exports_are_public(self) -> None:
    ...
    def test_connected_stereo_exports_are_public(self) -> None:
    ...
    def test_compatibility_exports_point_at_connected_nonstereo_branch(self) -> None:
        self.assertIs(
            enumerate_rooted_smiles_support,
            enumerate_rooted_connected_nonstereo_smiles_support,
        )
