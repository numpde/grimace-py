...
"""Fixture-only South Star prototype helpers.

The graph-native EnumS implementation lives under `grimace._south_star`.
This module keeps only the witness-backed prototype path that depends on
test fixtures and the semantic oracle.
"""
